      ...
      <Section tone="paper" size="lg">
        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Button href="#demo" variant="primary" size="lg">See it run →</Button>
            <Button href="/dashboard" variant="outline" size="lg">Open the dashboard</Button>
          </div>
        </div>
      </Section>
      ...
      <Section tone="white" size="lg">
        <div className="grid lg:grid-cols-12 gap-10 mb-12">
          <div className="lg:col-span-7">
            ...
            <SectionLede>
              No Zaps. No human stitching. The system runs itself until a senior needs to talk to a human.
            </SectionLede>
          </div>
        </div>
