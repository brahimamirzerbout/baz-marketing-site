      ...
      <div className="max-w-3xl">
        ...
        <div className="mt-12 space-y-10 text-[15px] leading-[1.75] text-foreground">
          <SubSection title="1. Acceptance">
            <p>
              By using {site.url} you agree to these terms. If you do not agree, do not use the
              site.
            </p>
          </SubSection>
          ...
          <SubSection title="2. Services">
            <p>
              Marketing services are governed by a separate Master Services Agreement signed at
              engagement. This site is informational.
            </p>
          </SubSection>
          ...
          <SubSection title="4. Disclaimers">
            <p>
              Case studies and testimonials describe representative engagements. Specific client
              names, metrics, and quotes are published only with signed consent. No content on this
