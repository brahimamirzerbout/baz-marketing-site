/**
 * The Selected Few — homepage teaser.
 * The scarcity hook (capped intake) + the link to /selected.
 * The moat: by selection, not purchase.
 */
  ...
  return (
    <section className="relative border-b border-border">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 py-24 lg:px-10 lg:py-32 text-center">
        ...
        <a
          href="/selected"
          className="mt-8 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-medium text-primary-foreground transition-transform hover:-translate-y-px"
        >
          Apply for selection →
        </a>
      </div>
