...
| Token | Light | Dark |
|---|---|---|
| brand-softer | #F0EBFF | #1A0D45 |
| brand-soft | #DDD0FF | #2D1A73 |
| brand | #6733FF | #7B4DFF |
| brand-medium | #C4B3FF | #2D1A73 |
| brand-strong | #5226D9 | #6733FF |
...
| Token | Light | Dark |
|---|---|---|
| fg-brand-subtle | #C4B3FF | #2D1A73 |
| fg-brand | #6733FF | #A17FFF |
| fg-brand-strong | #5226D9 | #C4B3FF |
...
| border-brand-subtle | #C4B3FF | #2D1A73 |
| border-brand-light | #7B4DFF | #7B4DFF |
| border-brand | #6733FF | #A17FFF |
