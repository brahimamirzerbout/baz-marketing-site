...
- **Heading font:** Playfair Display, serif — used exclusively for h1–h6 headings. Configured at app level via Google Fonts import.
- **Body / UI font:** Inter, sans-serif — used for paragraphs, labels, buttons, navigation, badges, inputs, and all other non-heading text. Configured at app level via Google Fonts import.
