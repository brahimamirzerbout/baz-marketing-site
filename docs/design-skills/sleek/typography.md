...
- **Font:** "Lotus Eden", sans-serif — configured at app level, never override
- **Headings:** extrabold weight (800), heading text color — all headings use "Lotus Eden ExtraBold" except card headings
- **Card headings:** medium weight (500), heading text color — card headings do not use extrabold
